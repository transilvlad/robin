package com.mimecast.robin.mtasts.client;

import com.mimecast.robin.mtasts.assets.StsRecord;
import com.mimecast.robin.mtasts.exception.PolicyFetchErrorException;
import com.mimecast.robin.mtasts.exception.PolicyWebPKIInvalidException;
import com.mimecast.robin.mtasts.util.FailingHttpsPolicyClient;
import com.mimecast.robin.mtasts.util.LocalHttpsPolicyClient;
import com.mimecast.robin.mtasts.util.LocalHttpsResponse;
import com.mimecast.robin.mtasts.util.LocalHttpsServer;
